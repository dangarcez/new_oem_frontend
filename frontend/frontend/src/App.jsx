      ...
      <div className="app">
         <header className="app-header">
            <div>
               ...
               <p className="muted">
                  Construa rapidamente arquivos YAML para configurar o OEM Ingest.
               </p>
            </div>
            <nav className="nav">
               <button
                  ...
                  <div className="panel">
                     <div className="panel-header">
                        ...
                        <div className="panel-actions">
                           ...
                           <button className="primary" type="button" onClick={saveConfig} disabled>
                              Enviar solicitacao
                           </button>
                        </div>
                     </div>
                                                   ...
                                                   <div className="metric-item-block" key={`metric-item-${index}`}>
                                                      ...
                                                      {entries.length > 0 && (
                                                         <div className="metric-fields">
                                                            {entries.map(([key, value]) => (
                                                               <div
                                                                  className={`metric-field ${keySet.has(key.toLowerCase()) ? 'metric-field-key' : ''
                                                                     }`}
                                                                  key={key}
                                                               >
                        ...
                        <div className="metric-group-list">
                           <div className="card-list">
                              {metricGroups.map((group) => {
                                 ...
                                 return (
                                    <div
                                       className={`card metric-group-card ${metricGroupHighlighted === group.name ? 'metric-group-active' : ''
                                          }`}
                                       key={group.name}
                                    >
                  ...
                  <div className="panel">
                     <div className="panel-header">
                        ...
                        <div className="panel-actions">
                           ...
                           <button className="primary" type="button" onClick={saveMetricsConfig} disabled>
                              Enviar solicitacao
                           </button>
                        </div>
                     </div>
                           ...
                           <div className="type-section">
                              ...
                              <div className="type-list">
                                 {newMetricItems.map((metric) => {
                                    ...
                                    return (
                                       <div
                                          className={`card metric-config-card ${isNew ? 'new-metric' : isModified ? 'modified-metric' : ''
                                             }`}
                                          key={metric._key}
                                       >
